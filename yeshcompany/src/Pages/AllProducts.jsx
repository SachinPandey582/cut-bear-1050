...
import { fetchUsers, sorttheuserpricefromhtl, sorttheuserpricefromlth } from '../Redux/Products/Product.Action';
  ...
  return (
    ...
    <div className={MSCss.upperContainer}>
      ...
      <div className={MSCss.SideCon}>
        <div>showing 1 - {store.data.length} Products of 12078 Products</div>
        <div>Sort By:-</div>
        <div><Button onClick={handleHTL}>Price High to Low</Button></div>
        <div><Button onClick={handleLTH}>Price low to High</Button></div>
      </div>
    </div>
